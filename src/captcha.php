...
class Captcha {
    // (A) CAPTCHA SETTINGS
    private $length = 4; // number of characters
    private $capW = 150; // captcha width
    private $capH = 50; // captcha height
    // private $capF = "C:/Windows/Fonts/arial.ttf"; // font - CHANGE TO YOUR OWN!
    private $capF = __DIR__ . DIRECTORY_SEPARATOR . "assets/dist/font/ProtestRevolution-Regular.ttf"; // font
    private $capFS = 24; // captcha font size
    // private $capB = __DIR__ . DIRECTORY_SEPARATOR . "CapBack.jpg"; // background image
    private $capB = "./assets/img/CapBack.jpg"; // background image
    ...
    function draw ($mode=0) : void {
        ...
        if ($mode==0) {
            ...
            echo "<img class='rounded' src='data:image/png;base64,$ob'>";
        } else {
